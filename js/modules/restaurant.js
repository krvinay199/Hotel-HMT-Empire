/**
 * restaurant.js — Hotel HMT Empire
 * Renders tabbed menu cards from Firestore with fallback data.
 */
...
/** Restaurant dining carousel navigation controls */
function initDiningCarouselArrows() {
  ...
  const getScrollAmount = () => {
    ...
    return card ? card.offsetWidth + 24 : 320; // card width + flex gap
  };
